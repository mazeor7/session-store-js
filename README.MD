...
This package provides a robust and flexible session management solution for Express.js applications. It supports two types of session storage: MemoryStore for in-memory storage and FileStore for file system persistence.
  ...
  <div align="center">
  <p>
    <a href="https://github.com/matteotorna/session-js/releases/latest">
  <img src="https://img.shields.io/github/v/release/matteotorna/session-js?style=for-the-badge" alt="GitHub release (latest SemVer)" /></a>
    <a href="https://github.com/matteotorna/session-js/releases/latest">
    <img src="https://img.shields.io/github/release-date/matteotorna/session-js?label=latest%20release&style=for-the-badge" alt="Latest release" /></a>
   <a href="https://www.npmjs.com/package/session-js"><img src="https://img.shields.io/npm/v/session-js.svg?logo=npm&style=for-the-badge" alt="npm version" /></a>
    <a href="https://www.npmjs.com/package/session-js"><img src="https://img.shields.io/npm/dt/session-js.svg?style=for-the-badge" alt="NPM downloads" /></a>
  </p>
</div>
